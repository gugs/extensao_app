...
public class Specie extends IDDescription {
    ...
    public static List<Specie> getDefaultSpecies() {
        ...
        e.add(new Specie(1, MeuRebanhoApp.getContext().getResources().getString(R.string.specie_caprine)));
        //e.add(new Specie(3, MeuRebanhoApp.getContext().getResources().getString(R.string.specie_equine)));
        e.add(new Specie(2, MeuRebanhoApp.getContext().getResources().getString(R.string.specie_ovine)));
